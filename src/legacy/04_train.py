...
def train_model(
    ...
    train_set = ImageDataset(os.path.join(dataset_folder, 'aug_train'))
    val_set = ImageDataset(os.path.join(dataset_folder, 'val'))
    #test_set = ImageNameDataset(os.path.join(dataset_folder, 'test'), sort = True)
    ...
    # (Initialize logging)
    experiment = wandb.init(project='U-Net_test', resume='allow', anonymous='must')
