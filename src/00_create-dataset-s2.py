...
if __name__ == '__main__':
    ...
    dataset_folder = f'../data/2024-12-08-seg2-dataset-{tile_size}'
    size = (tile_size,tile_size)
    tif_path = '../data/raw/2023-02-23_Bakonyszucs_actual.tif'
    shp_path = '../data/raw/Lombkorona.shp'#'../data/test_data/conc_biomed_full.shp'
    train_size = 0.8
    valid_size = 0.05
    batch_size = 1
    ...
    logging.basicConfig(level=logging.INFO,
                        format='%(asctime)s - %(levelname)s - %(message)s',
                        filename=f'../logs/create-dataset-s2-_{tile_size}.log',#'../logs/image_processing.log',
                        filemode='a')

    from utils.imageprocessing import split_SEG2, createPNG_Dataset_SEG, remove_empty_images
